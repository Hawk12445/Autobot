...
module.exports.run = async function({ api, event, args }) {
  try {
    ...
    const apiUrl = `https://api.zetsu.xyz/canvas/fbcover?name=${name}&subname=${subname}&sdt=${sdt}&address=${address}&email=${email}&uid=${uid}&color=${color}&apikey=3da1ef2e7b2bd47914aca0e4818ca4ad`;
